...
describe('7 - Crie as validações para as pessoas usuárias', function() {
  ...
  it('Será validado que o campo "vocation" é obrigatório', async function() {
    const result = await request(app).post('/users').send({
      username: 'username',
      password: 'senha1234',
      level: 2,
  ...
  it('Será validado que o campo "vocation" tem o tipo string', async function() {
    const result = await request(app).post('/users').send({
      username: 'username',
      password: 'senha1234',
      level: 2,
  ...
  it('Será validado que o campo "vocation" é uma string com mais de 2 caracteres', async function() {
    const result = await request(app).post('/users').send({
      username: 'username',
      password: 'senha1234',
      level: 2,
